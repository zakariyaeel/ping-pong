...
wind = turtle.Screen()  # intialize the window
wind.title("ping pong game")  # title of the widow
wind.bgcolor("black")
wind.setup(width=800, height=600)
wind.tracer(0)  # !! stop the window from updating automaticly
...
# main game looop
while True:
    wind.update()  # update everytime the loop run
